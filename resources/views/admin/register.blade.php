                            ...
                            <div class="card-body p-3 p-md-4 p-xl-5">
                                    ...
                                    <div class="row gy-3 overflow-hidden">
                                        <div class="col-12">
                                            <div class="form-floating mb-3">
                                                <input type="name" class="form-control @error('name') is-invalid  @enderror" name="name" id="name" placeholder="Username" >
                                        ...
                                        <div class="col-12">
                                            <div class="d-grid">
                                                <button class="btn bsb-btn-xl btn-secondary py-3" type="submit">Register Now</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="d-fl gexap-2 gap-md-4 flex-column flex-md-row justify-content-center">
